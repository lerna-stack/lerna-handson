...
object ConcertActorProtocol {
  ...
  case class CreateConcertRequest(concertId: ConcertId, numTickets: Int) extends ConcertCommandRequest
  ...
  case class GetConcertRequest(concertId: ConcertId) extends ConcertCommandRequest
  ...
  case class CancelConcertRequest(concertId: ConcertId)   extends ConcertCommandRequest
  ...
  case class BuyConcertTicketsRequest(concertId: ConcertId, numberOfTickets: Int) extends ConcertCommandRequest
